...
export default function ProgramPageClient({ program }: ProgramPageClientProps) {
  ...
  const IconComponent = ({ type }: { type: string }) => {
    const iconPaths = {
      benefits: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1",
      ...
      eligibility: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",
      ...
      howToApply: "M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z",
      resources: "M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"
    };

    return (
      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={iconPaths[type as keyof typeof iconPaths]} />
      </svg>
    );
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="card-enhanced rounded-xl p-6 shadow-lg stagger-animation">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-white">Program Structure</h2>
                </div>
                <p className="text-gray-300 leading-relaxed">
