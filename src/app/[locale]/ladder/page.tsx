                ...
                <div key={level.id} className="mb-8">
                  ...
                  <div className="bg-gray-800/40 backdrop-blur-md rounded-lg p-6 border border-white/10 relative">
                    ...
                    <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                      <div className={`w-12 h-12 bg-gradient-to-br ${level.gradient} rounded-full flex items-center justify-center shadow-lg`}>
                    ...
                    <div className="pt-4">
                      <div className="text-center mb-4">
                        <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${level.gradient} rounded-full mb-3`}>
                      ...
                      {index < levels.length - 1 && (
                        <div className="text-center mt-4">
                          ...
                          <div className="text-sm font-semibold text-blue-400">{level.nextLevel}</div>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div key={level.id} className="relative mb-24 z-20">
                  <div className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                    ...
                    <div className={`w-5/12 ${index % 2 === 0 ? 'pr-12' : 'pl-12'}`}>
                      <div className="bg-gray-800/40 backdrop-blur-md rounded-lg p-8 border border-white/10 transition-all duration-300 hover:bg-gray-800/50 hover:border-white/20 hover:scale-105">
                        <div className="flex items-center mb-4">
                          <div className={`w-12 h-12 bg-gradient-to-br ${level.gradient} rounded-full flex items-center justify-center mr-4`}>
                            <div className="text-white">
                              {level.icon}
                            </div>
                          </div>
                        ...
                        {index < levels.length - 1 && (
                          <div className="mt-6 pt-4 border-t border-gray-700/50">
                            ...
                            <div className="text-lg font-semibold text-blue-400">{level.nextLevel}</div>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="w-2/12 flex justify-center">
                      <div className={`w-20 h-20 bg-gradient-to-br ${level.gradient} rounded-full flex items-center justify-center shadow-2xl z-30 transition-all duration-300 hover:scale-110`}>
                ...
                <table className="w-full text-left">
                  <thead>
                    <tr className="border-b border-gray-600">
                      <th className="py-4 px-6 text-white font-semibold">Metric</th>
                      <th className="py-4 px-6 text-white font-semibold">Requirement (Per 2 Months)</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-300">
                    <tr className="border-b border-gray-700/50">
                      <td className="py-4 px-6">"Help Wanted" Issues</td>
                      <td className="py-4 px-6 text-green-400 font-semibold">≥ 2</td>
                    </tr>
                    <tr className="border-b border-gray-700/50">
                      <td className="py-4 px-6 font-semibold">PRs Merged</td>
                      <td className="py-4 px-6 text-green-400 font-semibold">≥ 3</td>
                    </tr>
                    <tr className="border-b border-gray-700/50">
                      <td className="py-4 px-6">PR Reviews or Constructive Comments</td>
                      <td className="py-4 px-6 text-green-400 font-semibold">≥ 8</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6">Community Meeting Attendance</td>
                      <td className="py-4 px-6 text-green-400 font-semibold">≥ 3</td>
                    </tr>
                  </tbody>
                </table>
